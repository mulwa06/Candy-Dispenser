...
isempty = candy_dispenser.is_empty()

stacksize = candy_dispenser.LEN()

top_item = candy_dispenser.top()
...
candy_dispenser.push(yellow)
msg = 'yellow was pushed'

candy_dispenser.push(red)
msg = 'red was pushed'

candy_dispenser.push(purple)
msg = 'purple was pushed'
